# SHE-Guardian: Flask backend (agents + alerts + voice endpoint placeholder)
import os
...
# --- Telegram alert config (fill these) ---
...
# --- Voice endpoint placeholder (wire after training the model) ---
@app.post("/voice_score")
def voice_score():
    return jsonify({"distress_prob": None, "distress_label": None, "msg":"Model not integrated yet"})
